...
def linearity_plots(fitted_values, residuals):
    ...
    sns.scatterplot(x=fitted_values, y=residuals, ax=axes[0, 0], color='purple', alpha=0.7)
    ...
    axes[1, 1].plot(residuals.index, residuals, marker='o', linestyle='', color='orange', alpha=0.7)
